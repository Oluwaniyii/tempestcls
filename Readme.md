...
The starter template is from [Sandor Turanszky's production-ready-expressjs-server](github.com://sandorTuranszky/production-ready-expressjs-server) with few tweaks to make it just enough for this project
